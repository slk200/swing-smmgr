...
public class XMLResolver {
    ...
    public XMLResolver(String xmlName) throws DocumentException {
        file = new File("src/org.tizzer.smmgr.config/org.tizzer.smmgr.system/" + xmlName);
    ...
    public XMLResolver putElementValue(String tagName, Object value) {
        Element element = root.element(tagName);
        element.setText(String.valueOf(value));
        return this;
    }

    public XMLResolver putElementValue(Map<String, Object> valMap) {
    ...
    public XMLResolver putAttributeValue(String tagName, Map<String, Object> valMap) {
        Element element = root.element(tagName);
        Set<Map.Entry<String, Object>> entry = valMap.entrySet();
        for (Map.Entry<String, Object> map : entry) {
